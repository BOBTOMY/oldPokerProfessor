import { getDefaultData, getSeatDefault } from './defaultData';
...
Page({
    ...
    /**
     * 获取数据之后的下一步操作
     * @param  {[Object]} t 返回结果（原始数据）
     * @param  {[type]} i 计时器
     * theme.trainType  1：训练 2：高手示范  0: 重玩
     */
    getGAmeAction: function(t, i) {
      var e = this;
    ...
    gameCard: function(t) {
        ...
        // debugger
        const seatDefault = getSeatDefault(getApp());
        a.defaultSeat(e), a.setData(Object.assign(
          {},
          {
            seats: e,
